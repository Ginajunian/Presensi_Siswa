    ...
    <div class="max-w-xl mx-auto space-y-4">
        ...
        @if ($siswa->foto)
            <div class="flex justify-center">
                <img src="{{ Storage::url($siswa->foto) }}" class="w-20 h-20 rounded-full object-cover">
            </div>
        @endif
            ...
            <form action="{{ route('siswa.update', $siswa) }}" method="POST" enctype="multipart/form-data"
                ...
                <div>
                    ...
                    <x-text-input id="nis" name="nis" type="text" inputmode="numeric" maxlength="10"
                        value="{{ old('nis', $siswa->nis) }}" class="w-full"
                ...
                <div>
                    ...
                    <x-text-input id="nama" name="nama" type="text" value="{{ old('nama', $siswa->nama) }}"
                        class="w-full" />
                ...
                <div>
                    <x-input-label for="foto" value="Ganti Foto (opsional)" />
